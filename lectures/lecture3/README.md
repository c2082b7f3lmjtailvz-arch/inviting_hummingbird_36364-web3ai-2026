# inviting_hummingbird_36364 - web3・AI概論 2026

> このリポジトリは **web3・AI概論 2026** の各回宿題提出物を **累積管理** するレポです。\
> 各回の宿題は `lectures/lecture[N]/` フォルダに収納されます。\
> リポ名は `inviting_hummingbird_36364-web3ai-2026` に統一(本名ではなく Discord ID を使う)。
...
| 項目 | 回答 |
|---|---|
| デプロイURL(Vercel等) | [GitHub Pagesで動作確認](https://c2082b7f3lmjtailvz-arch.github.io/inviting_hummingbird_36364-web3ai-2026/lectures/lecture3/prototype/) |
| 一言紹介 | LINEや日程メモのスクショから予定を自動抽出して登録するAIカレンダーアプリ |
